...
import download_datasets_depot
import base
import sys
...
def sargazoL2A(pathInputL1C,pathInput,pathOutput,pathTmp,pathLM,pathOutputEmpty,pathOutputGeoTiff,pathOutputWeb,pathOutputPeta,pathInputPeta,pathVertices,pathLog,dateTime):
    ...
    if dateTime != 'semiManual':
        try:
            ...
            # Dias solo de paso completo
            daysDelta = 1
            download_datasets_depot.search_and_download_datasets(tiles, start_date - datetime.timedelta(days=daysDelta), end_date - datetime.timedelta(days=daysDelta), pathInputL1C, unzip=False)
...
if __name__ == "__main__":
    ...
    pathVertices = '/data/output/sentinel2/sentinel2/l2/geojson/sargazo_vertices/'
