...
def manual():
    ...
    while True:
        resR = int(input())
        if resR == 1 or resR == 2 or resR == 3 or resR == 4 or resR == 5 or resR == 6 or resR == 7 or resR == 8 or resR == 9 or resR == 10 or resR == 11 or resR == 12 or resR == 13:
            break
    if resR == 1:
        region = "sargazo_1"
    elif resR == 2:
        ...
        for archivo in archivos:            
            ...
            if (processing_sentinel2.verificaSargazoDB(tile,fecha) == 0) and not(tile[1:] in tiles == True):                   
                ...
                try:
                    ...
                    if (dateTime == 'manual' or dateTime == 'automatico'  or dateTime == 'automaticoTile' or dateTime == 'semiManualTile') and SNbuffer == True:
