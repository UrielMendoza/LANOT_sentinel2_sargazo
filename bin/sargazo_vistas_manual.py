...
if __name__ == "__main__":
    ...
    for fecha in fechas:
        ...
        uneVectorial(4326,'sargazo_segmentados',pathVertices+'sargazo_segmentados/','2023-03-02',pathVertices+'sargazo_segmentados/s1/',pathOutputPeta,pathOutputWeb)
