...
pathInputPeta     = '/peta/sentinel2/L1C/'      # ajustar si aplica
...
def generaRGB_porTile(archivoL1C, fecha, tile, bandas20m):
    ...
    Retorna el nombre del archivo L2A y el archivoProc.
    """
    ...
    # 3. Convertir bandas 20m a GeoTIFF (solo las necesarias para el RGB FC)
...
def generaMosaicos(fechaDia, region):
    ...
    if tilesFaltantes:
        ...
        # Bandas necesarias para RGB (TC y FC). No incluyen SCL ni B08
        # porque sin algoritmo de sargazo no se necesitan.
    ...
    # 3. Verificar que al menos tengamos fecha resuelta
    if fecha is None:
